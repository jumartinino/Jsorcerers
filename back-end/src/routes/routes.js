...
router.post('/buys', validator.validationBuying, BuyingController.create);
...
router.post('/carts', validator.validationCart, CartController.create);
router.put('/carts/:id', CartController.update);
router.delete('/carts/:id', CartController.destroy);

router.get('/comments',CommentController.index);
router.get('/comments/:id',CommentController.show);
router.post('/comments', validator.validationComment, CommentController.create);
...
router.post('/posts', validator.validationPost, PostController.create);
router.put('/posts/:id', PostController.update);
router.delete('/posts/:id', adminMiddleware, PostController.destroy);

router.get('/products',ProductController.index);
router.get('/products/:id',ProductController.show);
router.post('/products', validator.validationProduct, ProductController.create);
router.put('/products/:id', ProductController.update);
router.delete('/products/:id', ProductController.destroy);

router.get('/questions',QuestionController.index);
router.get('/questions/:id',QuestionController.show);
router.post('/questions', validator.validationQuestion, QuestionController.create);
...
router.post('/shops', validator.validationUser_Shop, User_ShopController.create);
router.put('/shops/:id', User_ShopController.update);
router.delete('/shops/:id', User_ShopController.destroy);

router.get('/users',UserController.index);
router.get('/users/:id',UserController.show);
router.post('/users', validator.validationUser, UserController.create);
